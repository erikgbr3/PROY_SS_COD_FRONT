...
export default function LeaguesAdminCard(props: cardProps) {
  return (
    <View style={styles.tarjeta}>
      <Image source={require('../../../../../assets/ligamx.jpg')} style={styles.imagen} />
      <Text style={styles.nombre}>{props.leagueA.name}</Text>
