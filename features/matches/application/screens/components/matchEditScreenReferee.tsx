...
const MatchEditRefereeView: FC<MatchEditViewProps> = ({matchEdit, onSaved, menuVisible, onCancelEdit}) => {
...
const matchEditScreenReferee = (props: any) => {
  const { clubs } = useClubsState();

 return (
  <EditMatchProvider clubs={clubs}>
    <MatchEditRefereeView {...props}/>
  </EditMatchProvider>
 )
};

export default matchEditScreenReferee;
